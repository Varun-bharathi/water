    ...
    <div className="min-h-screen text-slate-200 py-12 px-4 flex flex-col items-center bg-[#0f0a0a] relative overflow-x-hidden">
      ...
      <div className="w-full max-w-3xl z-10">
        ...
        <header className="text-center mb-10">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-b from-red-500 via-orange-500 to-yellow-600 italic tracking-tighter uppercase">
            Aqua Hazard
          </h1>
          <p className="text-orange-200/40 font-mono mt-3 uppercase text-[10px] tracking-[0.4em]">
